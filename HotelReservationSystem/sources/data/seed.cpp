...
std::vector<Hotel> criarHoteisFicticios() {
    ...
    h1->adicionarQuarto(Room(102, 102, 120.0, RoomType::DOUBLE, h1));
    ...
    h2->adicionarQuarto(Room(202, 202, 140.0, RoomType::DOUBLE, h2));
    ...
    h3->adicionarQuarto(Room(302, 302, 100.0, RoomType::DOUBLE, h3));
    ...
    h4->adicionarQuarto(Room(402, 402, 125.0, RoomType::DOUBLE, h4));
    ...
    h5->adicionarQuarto(Room(502, 502, 110.0, RoomType::DOUBLE, h5));
    ...
    h6->adicionarQuarto(Room(602, 602, 145.0, RoomType::DOUBLE, h6));
